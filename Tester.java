...
public class Tester
{
    public static void main(String[] args)
    {
        ...
        //pen
        System.out.println("");
        System.out.println("Testing the Pen Class");
        Pen edithsPen = new Pen();
        System.out.println("Constructing the Pen");
        System.out.println("");
        
        System.out.println("Is the pen cap on?");
        if (edithsPen.getCap())
        {
        ...
        System.out.println("How much ink do we have?");
        System.out.println(edithsPen.getInkAmount() + " mL");
        System.out.println("");
        
        System.out.println("Let me try writing hello");
        System.out.println("It shouldn't work since the cap is still on.");
        System.out.println(edithsPen.write("hello"));
        System.out.println("");
        
        System.out.println("Let's remove the cap");
        edithsPen.capOff();
        System.out.println("Is the pen cap on?");
        if (edithsPen.getCap())
        {
        ...
        System.out.println("How much ink is left?");
        System.out.println(edithsPen.getInkAmount() + " mL");
        System.out.println("");
        
        System.out.println("What happens if I try to write nothing");
        System.out.println(edithsPen.write("   "));
        System.out.println("");
        ...
        System.out.println("Let's refill the ink");
        edithsPen.refillInk();
        System.out.println("");
        ...
        System.out.println("Let's put the cap back on");
        edithsPen.capOn();
        System.out.println("");
